    <div class="col-lg-9 eqLogic ipx800_bouton" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_ipx800_bouton" class="table table-bordered table-condensed ipx800_bouton">
            <thead>
                <tr>
