    <div class="col-lg-9 eqLogic ipx800_relai" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_ipx800_relai" class="table table-bordered table-condensed ipx800_relai">
            <thead>
                <tr>
